...
- Cross-page hints for repeated page titles and potentially inconsistent
  navigation, help mechanisms, and same-purpose control names.
...
direct links to the matching visual evidence and a short comparison queue.
...
with direct links to the matching visual evidence and a short comparison queue.
...
[external validation](docs/recipes/external-validation.md),
