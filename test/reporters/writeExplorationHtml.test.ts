...
test("writeExplorationHtml can create a unified audit report", async () => {
  ...
  assert.match(html, /Review record fields: per-step status, task outcome, first blocker, blocker severity, missing states, remediation owner, retest date, and evidence links\./);
