...
- Continue cross-browser evidence beyond the current `--browser` and
  ...
  queue, and reproduction signals for manual triage; next, add screenshot-level
  visual diffing. Clearly label browser-specific differences for manual review
...
- Continue responsive web evidence beyond the current `--mobile`, `--tablet`,
  ...
  visual-evidence-link, comparison queue, and reproduction signals for manual
  triage; next, add screenshot-level visual diffing. Treat this as
