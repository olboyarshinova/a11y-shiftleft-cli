...
- Continue incremental scan support for pull requests. Current `check
  ...
  relative to a base ref, and generated GitHub PR workflows use it alongside a
  bounded dynamic crawl. Next, connect a small configured set of dynamic
  smoke-test URLs before broader scheduled scans.
