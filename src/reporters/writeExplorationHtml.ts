...
function renderCoverageMatrix(
  ...
  const rows = [
    ...
    coverageRow("sensory-color-instructions", "Sensory and color-only instructions", "needs-review", options.manualChecklist ? "Checklist ready" : "Human review required", "Review instructions, legends, charts, filters, and validation copy for color-only, position-only, sound-only, or shape-only cues"),
    coverageRow("text-spacing", "Text spacing resilience", "needs-review", options.manualChecklist ? "Checklist ready" : "Human review required", "Apply text-spacing overrides and confirm content, controls, and errors do not clip, overlap, or disappear"),
    coverageRow("account-authentication-flow", "Account and authentication flow", "needs-review", options.manualChecklist ? "Checklist ready" : "Human review required", "Review login, checkout, account recovery, and multi-step forms for redundant entry and cognitive authentication barriers"),
    coverageRow("time-limits-recovery", "Time limits and recovery", "needs-review", options.manualChecklist ? "Checklist ready" : "Human review required", "Review timeout warnings, session extension, interrupted tasks, data preservation, and legal/financial/data-change confirmation"),
    coverageRow("cognitive-clarity", "Predictable actions and calm recovery", "needs-review", options.manualChecklist ? "Checklist ready" : "Human review required", "Review task copy, button labels, errors, recovery paths, help access, and multi-step form clarity"),
    ...
    coverageRow("task-completion-worksheet", "Task completion worksheet", "needs-review", options.manualChecklist ? "Checklist ready" : "Human review required", "Record task, environment, input method, inclusive constraint, outcome, blocker, owner, and retest date without unnecessary personal data"),
