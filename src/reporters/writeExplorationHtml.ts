...
function renderReflowEvidence(state: ExplorationState): string {
  ...
  if (!reflow || (reflow.horizontalOverflowPx <= 1 && reflow.clippedTextCount === 0 && overlapCount === 0)) return "";
  return `<details>
