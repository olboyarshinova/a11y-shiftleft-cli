...
const RULE_TO_WCAG: Record<string, string[]> = {
  ...
  "frame-title": ["4.1.2"],
  "form-invalid-error-not-associated": ["3.3.1", "3.3.2"],
  "forced-colors-adjust-none": ["1.4.11"],
  "forced-colors-background-image-risk": ["1.4.1", "1.4.11"],
  "forced-colors-focus-indicator-risk": ["2.4.7", "2.4.11"],
  ...
  "image-alt-duplicates-nearby-text": ["1.1.1"],
  "image-alt-repeated": ["1.1.1"],
  "image-alt-excessive-length": ["1.1.1"],
  ...
  "sensory-instruction-risk": ["1.3.3", "1.4.1", "3.3.2"],
  "link-name": ["2.4.4", "4.1.2"],
  "marquee": ["2.2.2"],
  "media-video-captions-not-detected": ["1.2.2"],
  "media-audio-transcript-not-detected": ["1.2.1"],
  "media-autoplay-control-risk": ["1.4.2"],
  "meta-refresh": ["2.2.1"],
  "meta-viewport": ["1.4.4"],
